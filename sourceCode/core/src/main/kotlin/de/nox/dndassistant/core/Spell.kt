...
data class Spell(
	...
	val durationSeconds: Int = 0, // seconds.
	val duration: String = "$durationSeconds seconds", // desciption?.
	val ritual: Boolean = false,
	val attackSave: Ability? = null, // eg. wisdom saving throw against Spell DC
	val effect: String = "", // eg. 8d6 (fire damage)
	val note: String = "",
	val learntByKlasses: List<Klass> = listOf(),
	val onHigherSpellslots: Map<Int, String> = mapOf() // e.g. higher damage each extra spell slot?
	// spellTags: String = "", // heal, damage, charm, buff, debug, environmental, poison, ...
	)
	: Comparable<Spell> {
